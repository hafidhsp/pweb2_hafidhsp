        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="/form"><i class="sidebar-item-icon fa fa-th-large"></i>
                            <span class="nav-label">Form</span>
                        </a>
                    </li>
                    <li>
                        <a class="active" href="/data_daerah"><i class="sidebar-item-icon fa fa-th-large"></i>
                            <span class="nav-label">Tabel</span>
                        </a>
                    </li>
                    @endif
                    <li>
                        <a class="active" href="/tabel"><i class="sidebar-item-icon fa fa-th-large"></i>
                            <span class="nav-label">Lihat</span>
                        </a>
                    </li>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>ID Daerah</th>
                                        <th>Nama Daerah</th>
                                        <th>Jumlah Banjir per Tahun</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach ($data_daerah as $r)
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <a href="/form">
                                            <button class="btn btn-outline-primary" data-toggle="tooltip" data-original-title="Tambah Data"><i class="fa-solid fa-file"></i></button>
                                            </a>
                                            </td>
                                            <td>
                                            <button class="btn btn-outline-warning" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil font-14"></i></button>
                                            </td>
                                            <form action="/data_daerah/{{$r->id_daerah}}" method="POST">
                                            <td>
                                            @scrf
                                            @method('delete')
                                            <button type="submit" class="btn btn-outline-danger" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash font-14"></i></button>
                                            </td>
                                            </form>
                                        @endforeach
                                    </tr>
