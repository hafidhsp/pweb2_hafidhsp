    ...
    <div class="page-wrapper">
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <span></span>Hafidh<i class="fa fa-angle-down m-l-5"></i></a>
            ...
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong">Hafidh</div><small>Administrator</small></div>
                </div>
                <ul class="side-menu metismenu">
                    ...
                    <li class="active">
                        <a href="/form"><i class="sidebar-item-icon fa fa-edit"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Form Data Banjir</h1>
            </div>
                        ...
                        <div class="ibox">
                            ...
                            {{csrf_field()}}
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="nama_daerah" placeholder="Nama Daerah">
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah Banjir/Tahun</label>
                                        <input class="form-control" type="text" name="banjir" placeholder="Jumlah Banjir/Tahun">
                                    </div>
                                    <div>
                                    </div>
                                    <div class="form-group">
